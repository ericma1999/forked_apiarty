...
|:---:|:---:|:---:|:---:|:---:|:---:|:---:|:---:|:---: |:---:|:---:|:---:|:---:|:---:|
| VUL4J-2|:x:|:x:|:x:|:x:|:x:|:x:|:x:|:x:|:x:|:x:|:x:|:x:|:hammer_and_wrench:
| VUL4J-3|:x:|:x:|:x:|:x:|:x:|:x:|:x:|:x:|:x:|:x:|:x:|:x:|:hammer_and_wrench:
| VUL4J-7|:x:|:clock1230:|:x:|:x:|:x:|:x:|:x:|:x:|:x:|:x:|:x:|:x:|:hammer_and_wrench:
| VUL4J-8|:clock1230:|:clock1230:|:clock1230:|:clock1230:|:clock1230:|:clock1230:|:clock1230:|:clock1230:|:x:|:clock1230:|:x:|:x:|:hammer_and_wrench:
| VUL4J-9|:clock1230:|:x:|:x:|:x:|:x:|:x:|:x:|:x:|:x:|:x:|:x:|:x:|:hammer_and_wrench:
| VUL4J-10|:x:|:x:|:x:|:x:|:x:|:x:|:x:|:x:|:x:|:white_check_mark:|:x:|:x:|:hammer_and_wrench:
| VUL4J-11|:x:|:x:|:x:|:x:|:x:|:x:|:x:|:x:|:x:|:x:|:x:|:x:|:hammer_and_wrench:
| VUL4J-19|:x:|:x:|:x:|:x:|:x:|:x:|:x:|:x:|:x:|:x:|:x:|:x:|:hammer_and_wrench:
| VUL4J-23|:x:|:x:|:x:|:x:|:x:|:x:|:x:|:x:|:x:|:x:|:x:|:x:|:hammer_and_wrench:
| VUL4J-24|:x:|:x:|:x:|:x:|:x:|:x:|:x:|:x:|:x:|:x:|:x:|:x:|:hammer_and_wrench:
| VUL4J-34|:x:|:x:|:x:|:x:|:x:|:x:|:x:|:x:|:x:|:x:|:x:|:x:|:hammer_and_wrench:
| VUL4J-44|:x:|:x:|:x:|:x:|:x:|:x:|:x:|:x:|:x:|:x:|:x:|:x:|:hammer_and_wrench:
| VUL4J-45|:x:|:x:|:x:|:x:|:x:|:x:|:x:|:x:|:x:|:x:|:x:|:x:|:hammer_and_wrench:
| VUL4J-46|:x:|:x:|:x:|:x:|:x:|:x:|:x:|:x:|:x:|:x:|:x:|:x:|:hammer_and_wrench:
| VUL4J-47|:x:|:x:|:x:|:x:|:x:|:x:|:x:|:x:|:x:|:x:|:x:|:x:|:hammer_and_wrench:
| VUL4J-48|:x:|:x:|:x:|:x:|:x:|:x:|:x:|:x:|:x:|:x:|:x:|:x:|:hammer_and_wrench:
| VUL4J-51|:clock1230:|:x:|:x:|:clock1230:|:x:|:x:|:clock1230:|:x:|:hammer_and_wrench:|:x:|:x:|:x:|:hammer_and_wrench:
| VUL4J-56|:x:|:x:|:x:|:x:|:x:|:x:|:x:|:x:|:x:|:x:|:x:|:x:|:hammer_and_wrench:
| VUL4J-57|:x:|:x:|:x:|:x:|:x:|:x:|:x:|:x:|:x:|:x:|:x:|:x:|:hammer_and_wrench:
| VUL4J-61|:x:|:x:|:x:|:x:|:x:|:x:|:x:|:x:|:x:|:x:|:x:|:x:|:hammer_and_wrench:
| VUL4J-64|:x:|:x:|:x:|:x:|:x:|:x:|:x:|:x:|:x:|:x:|:x:|:x:|:hammer_and_wrench:
| VUL4J-71|:x:|:x:|:x:|:x:|:x:|:x:|:x:|:x:|:x:|:x:|:x:|:x:|:hammer_and_wrench:
| VUL4J-74|:x:|:x:|:x:|:x:|:x:|:x:|:x:|:x:|:x:|:x:|:x:|:x:|:hammer_and_wrench:
| VUL4J-77|:x:|:x:|:x:|:x:|:x:|:x:|:x:|:x:|:x:|:x:|:x:|:x:|:hammer_and_wrench:

* :clock1230: The tool timed out (7200 seconds)
* :white_check_mark: The tool completes and successful generate a plausible patch
* :x: The and did not generate a plausible patch or unknown repair result
